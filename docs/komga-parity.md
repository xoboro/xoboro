...
167 schemas. Twenty-six operations are partially implemented and none are yet
...
| SQLite schema and migrations | PARTIAL | Flyway V1-V12 clean-install and V1-to-current upgrade tests |
