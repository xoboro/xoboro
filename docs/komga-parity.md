...
| OPDS v2 and authentication document | PARTIAL | All 30 feed, browse, search, artwork, page, profile manifest, authentication-document, and progression operations reuse shared WebPub/progress boundaries; one-based page delivery, exact page/thumbnail ETags, timestamp-first source bypass, synthetic integration coverage, and live media differential fixtures are implemented; exact unauthorized document and feed differential fixtures pending |
