...
| OPDS v1 | PARTIAL | All 18 Atom/OpenSearch catalog, browse, acquisition, thumbnail, and page operations use access-filtered catalog data; zero-based page translation, exact page/thumbnail ETags, timestamp-first source bypass, UTF-8 dispositions, synthetic route coverage, and live media differential fixtures are implemented; differential XML and failure fixtures pending |
| OPDS v2 and authentication document | PARTIAL | All 30 feed, browse, search, artwork, page, profile manifest, authentication-document, progression, and OPDS acquisition operations reuse shared catalog/WebPub/progress/media boundaries; recommended, browse, title search, compact publications, paging, subsection navigation, publisher facets, acquisition streaming, one-based page delivery, feed ETag emission, and page/thumbnail revalidation are synthetic-tested, with catalog/browse/search plus media contracts live-differential-certified against Komga 1.25.0; remaining collection/read-list/detail feeds, unauthorized behavior, advanced relevance, and failure fixtures need live certification |
