...
| Capability | Status | Evidence |
|---|---|---|
| Komga REST API v1/v2 | PARTIAL | All 165 pinned operations have an implementation in progress, including management info, font resources, release discovery, durable poster regeneration, atomic duplicate-page removal, and a post-serialization shallow ETag filter across successful byte-array GET responses with exact Komga exclusions; differential certification and exact schema/error completion pending |
