...
| Page streaming and conversion | PARTIAL | Exact analyzed-entry streaming, EPUB resource streaming, PDF JPEG rendering and raw single-page extraction, raw and zero-based routes, JPEG/PNG conversion, bounded page thumbnails, role and catalog-access enforcement, CSP, resource-lifetime tests, Komga UTF-8 inline names, non-PDF raw rejection, and live byte-exact original/JPEG/thumbnail certification; PDF Accept negotiation and conditional ETag semantics pending |
