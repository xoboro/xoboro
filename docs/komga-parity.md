...
| OPDS v1 | PARTIAL | All 19 Atom/OpenSearch catalog, browse, acquisition, thumbnail, page, and wildcard-download operations use access-filtered catalog data; Komga-exact valid Atom/OpenSearch structure, feed/entry metadata, filtering, paging links, navigation/acquisition/PSE links, organization ordering, zero-based page translation, exact page/thumbnail ETags, timestamp-first source bypass, UTF-8 dispositions, and archive acquisition are synthetic-tested and covered by 23 live XML/failure plus 12 media differential cases; exact unauthorized JSON body and Basic challenge formatting remain |
| OPDS v2 and authentication document | PARTIAL | All 30 feed, browse, search, collection/read-list/series detail, artwork, page, profile manifest, authentication-document, progression, and OPDS acquisition operations reuse shared catalog/WebPub/progress/media boundaries; exact paging, subsection navigation, compact publications, organization ordering/access, publisher and tag facets, summary fallback, acquisition streaming, one-based page delivery, feed ETag emission, and page/thumbnail revalidation are synthetic-tested, with every feed category and media contracts live-differential-certified against Komga 1.25.0; unauthorized behavior, advanced relevance, and failure fixtures remain |
